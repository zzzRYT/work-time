...
export function VacationButton({
  ...
  if (!expanded) {
    return (
      <Pressable
        className={cn(
          "bg-vacation-bg border border-vacation/30 rounded-lg py-3 px-4 items-center",
          disabled && "opacity-50",
          className
        )}
  ...
  return (
    <View className={cn("bg-vacation-bg rounded-lg p-4", className)}>
      ...
      <Pressable
        className={cn(
          "bg-vacation rounded-lg py-3 items-center",
