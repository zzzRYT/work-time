...
CREATE TABLE "new_monthly_fees" (
    ...
    "month" TEXT NOT NULL,
    "monthlyFeeStatus" TEXT NOT NULL DEFAULT 'UNPAID',
    "lateFeeStatus" TEXT NOT NULL DEFAULT 'UNPAID',
    CONSTRAINT "monthly_fees_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "members" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_monthly_fees" ("id", "memberId", "month") SELECT "id", "memberId", "month" FROM "monthly_fees";
